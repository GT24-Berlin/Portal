...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot='command'
      className={cn(
        'bg-popover/92 text-popover-foreground border-border/60 flex h-full w-full flex-col overflow-hidden rounded-2xl border shadow-[var(--shadow-glass)] backdrop-blur-xl',
        className
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    ...
    >
      <SearchIcon className='text-muted-foreground size-4 shrink-0 opacity-70' />
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        'text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:tracking-[0.08em] [&_[cmdk-group-heading]]:uppercase',
        className
      )}
      {...props}
    />
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        'text-muted-foreground ml-auto text-xs tracking-[0.14em]',
        className
      )}
      {...props}
    />
